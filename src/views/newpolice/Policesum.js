...
const CustomStyles = () => {
  ...
  return (
    ...
    >
      <CCol md={3}>
        <CFormLabel htmlFor="validationCustomCity2">Stations :</CFormLabel>
      ...
      <CCol md={3}>
        <CFormLabel htmlFor="validationCustomDOB">From Date :</CFormLabel>
      ...
      <CCol md={3}>
        <CFormLabel htmlFor="validationCustomDOB">To Date :</CFormLabel>
        <CFormInput type="date" id="validationCustomDOB" required />
        <CFormFeedback invalid>Please provide a valid date of birth.</CFormFeedback>
      </CCol>

      <CCol md={3}>
        <CFormLabel htmlFor="validationCustomCity2">View Type :</CFormLabel>
        <CFormSelect id="validationCustomCity2" required>
          <option disabled>Choose...</option>
          <option>--select--</option>
        </CFormSelect>
    ...
    <CRow>
      <CCol xs={12}>
        <CCard className="mb-4">
          <CCardHeader>
            <strong>New Police Summery Report :</strong>
          </CCardHeader>
          <CCardBody>
            <CustomStyles />
          </CCardBody>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          <CCardHeader>
            <strong>List data will come here..</strong>
          </CCardHeader>
          <CCardBody>
            <CustomStyles1 />
          </CCardBody>
