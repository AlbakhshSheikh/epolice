...
const CustomStyles = ({ formData, handleInputChange, handleSubmit }) => {
  ...
  return (
    ...
    >
      <CCol md={6}>
        <CFormLabel htmlFor="stationName">Police Station:</CFormLabel>
        <CFormSelect
          id="stationName"
          required
          value={formData.Name}
        ...
        >
          ...
          <option value="DYSP BALLAPUR">DYSP BALLAPUR</option>
          <option value="DYSP AKOT">DYSP AKOT</option>
          <option value="DYSP NAGPUR">DYSP NAGPUR</option>
          <option value="DYSP PUNE">DYSP PUNE</option>
          {/* Add more options as needed */}
        </CFormSelect>
        <CFormFeedback invalid>Please select a valid police station.</CFormFeedback>
      </CCol>
    ...
    <CRow>
      ...
      <CCol xs={12} >
        <CCard className="mb-4">
          <CCardHeader>
            <strong>Police Station Mapping:</strong>
          </CCardHeader>
          <CCardBody>
